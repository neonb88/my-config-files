...
# python
alias python='date && time python'
alias python2='date && time python2'
alias python3='date && time python3'
alias p='time python' # adaptive to the designated conda environment (if you made the conda env to run python2, "python" actually runs "python2")
...
alias 2='ac mgn1'
alias 3='ac mgn_py37'
export PYTHONPATH=$PYTHONPATH:$HOME/lib #cx.py
...
alias a='attach'
alias attach2='sudo docker attach 5b1c347bf448'
alias a2='attach2'

alias gsu='gsutil ls gs://*'
alias lis='gcloud compute instances list'
alias sto='gcloud compute instances stop  mgn-3'   # easier to remember is "always the 1st 3 letters for a TLA"
